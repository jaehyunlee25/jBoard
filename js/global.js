...
function layerpop(opt){
	...
	div.style.cssText="position:fixed;top:0px;left:0px;width:100%;height:100%;background-color:rgba(0,0,0,0.5);z-index:"+layerPopPriority+";";
...
function layerAlert(str,fnc,opt){
	...
	hdrCells[0][0].parentNode.parentNode.style.cssText="height:100%;width:100%;";
	hdrCells[0][0].style.cssText="text-align:center;background-color:purple;color:white;font-weight:bold;";
	
	bodyCells[0][0].parentNode.parentNode.style.cssText="height:100%;width:100%;";
	bodyCells[0][0].style.cssText="padding:10px;text-align:center;background-color:white;font-weight:bold;";
...
function layerPrompt(str,round,def,fnc){
	...
	bodyCells[1][0].style.cssText="padding:10px;text-align:center;background-color:white;font-weight:bold;";
